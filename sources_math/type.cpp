...
{
	template<typename T>
	T const* value_ptr(vec<1, T> const& v)
	{
		return &(v.x);
	}

	template<typename T>
	T* value_ptr(vec<1, T>& v)
	{
		return &(v.x);
	}
	...
	template<typename T>
	T const * value_ptr(qua<T> const& q)
	{
		return &(q[0]);
	}
	...
	template<typename T>
	vec<2, T> make_vec2(T const *const ptr)
	{
		vec<2, T> Result;
	...
	template<typename T>
	vec<3, T> make_vec3(T const *const ptr)
	{
		vec<3, T> Result;
	...
	template<typename T>
	vec<4, T> make_vec4(T const *const ptr)
	{
		vec<4, T> Result;
	...
	template<typename T>
	mat<2, 2, T> make_mat2x2(T const *const ptr)
	{
		mat<2, 2, T> Result;
	...
	template<typename T>
	mat<2, 3, T> make_mat2x3(T const *const ptr)
	{
		mat<2, 3, T> Result;
	...
	template<typename T>
	mat<2, 4, T> make_mat2x4(T const *const ptr)
	{
		mat<2, 4, T> Result;
	...
	template<typename T>
	mat<3, 2, T> make_mat3x2(T const *const ptr)
	{
		mat<3, 2, T> Result;
	...
	template<typename T>
	mat<3, 3, T> make_mat3x3(T const *const ptr)
	{
		mat<3, 3, T> Result;
	...
	template<typename T>
	mat<3, 4, T> make_mat3x4(T const *const ptr)
	{
		mat<3, 4, T> Result;
	...
	template<typename T>
	mat<4, 2, T> make_mat4x2(T const *const ptr)
	{
		mat<4, 2, T> Result;
	...
	template<typename T>
	mat<4, 3, T> make_mat4x3(T const *const ptr)
	{
		mat<4, 3, T> Result;
	...
	template<typename T>
	mat<4, 4, T> make_mat4x4(T const *const ptr)
	{
		mat<4, 4, T> Result;
	...
	template<typename T>
	mat<2, 2, T> make_mat2(T const *const ptr)
	{
		return make_mat2x2(ptr);
	}

	template<typename T>
	mat<3, 3, T> make_mat3(T const *const ptr)
	{
		return make_mat3x3(ptr);
	}

	template<typename T>
	mat<4, 4, T> make_mat4(T const *const ptr)
	{
		return make_mat4x4(ptr);
	}

	template<typename T>
	qua<T> make_quat(T const *const ptr)
	{
		qua<T> Result;
		memcpy(value_ptr(Result), ptr, sizeof(qua<T>));
		return Result;
	}
